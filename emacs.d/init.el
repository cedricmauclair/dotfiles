...
(custom-set-variables
 ...
 '(bs-must-always-show-regexp "\\*vc-dir\\*")
 ...
 '(font-latex-match-italic-declaration-keywords (quote (("italic" "") ("slanted" "") ("english" "") ("locution" ""))))
...
found there."
  ...
  (defun my:set-keys (func from to)
    (eval `(global-set-key (kbd ,(concat prefix (char-to-string from)))
      (lambda nil (interactive) (,func ,from ,to (point) t))))
    (eval `(global-set-key (kbd ,(concat pprefix (char-to-string from)))
      (lambda nil (interactive) (,func ,from ,to (point) nil))))
    (eval `(global-set-key (kbd ,(concat prefix (char-to-string to)))
      (lambda nil (interactive) (,func ,from ,to (point) t))))
    (eval `(global-set-key (kbd ,(concat pprefix (char-to-string to)))
      (lambda nil (interactive) (,func ,from ,to (point) nil)))))
